...
//      var consultationGrid = this.getComponent('consultations');
//      consultationGrid.on('show', function(view, options){
//        Ext.msg.alert('Debug','show');
//          this.consultationGrid.store.sort('consultation_date', 'DESC');
//      }, this);
